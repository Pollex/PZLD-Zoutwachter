...
#ifndef WS2812B_CONSTANTS_H
#define WS2812B_CONSTANTS_H
 ...
 */
#define WS2812B_T_DATA_NS                (1250U)

/**
 * @brief The high-times in nanoseconds.
 * @{
 */
#define WS2812B_T_DATA_ONE_NS            (650U)
#define WS2812B_T_DATA_ZERO_NS           (325U)
/**@}*/
